...
namespace Tsonic.CSharp.Js
{
    public sealed class Int16Array : TypedArray<Int16Array, short>
    {
        ...
        {
            System.ArgumentNullException.ThrowIfNull(source);
            TypedArrayCopy.Checked<TSource, short>(source.NativeElements, NativeDestination(source.NativeLength, offset));
        }
        ...
        protected override short ToElement(double value) => checked((short)value);
